...
public class LobListInitializer implements SearchParameterInitializer {
    ...
    public boolean initializeParameter(SearchParameter parameter, Map context) {
        if(parameter instanceof SearchParameterSelect){
            ...
            List<String> lobTypes = pcmConfigUtil.getList("pcm.functional.lob.types", new ArrayList<String>());
            for(String Lob: lobTypes)
            {
