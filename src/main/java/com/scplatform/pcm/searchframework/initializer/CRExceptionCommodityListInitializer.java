...
public class CRExceptionCommodityListInitializer implements SearchParameterInitializer {
	...
	public boolean initializeParameter(SearchParameter parameter, Map context) {
		if (parameter instanceof SearchParameterSelect)
		{
			...
			List<String> commodityTypes = pcmConfigUtil.getList("pcm.costrecord.exception.allowableCommodityTypes", new ArrayList<String>());
			
			for (String excepState: commodityTypes)
			{
