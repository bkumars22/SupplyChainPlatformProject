...
The icons are designed under the [material design guidelines](https://material.io/guidelines/). Added support for new variants of Material design icons from (https://github.com/google/material-design-icons/tree/master/font).
