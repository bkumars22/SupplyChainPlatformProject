...
@CucumberOptions(plugin = {
    ...
    "json:target/cucumber-html-report/b2b_parallel_upload.json",
    "html:target/cucumber-html-report/cucumber.html",
    "junit:target/cucumber-junit-report.xml" },
    features = {
        "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/B2BParallelUpload.feature" },
    glue = {
        "com.test.selenium.common.steps",
        "com.test.selenium.scplatform.steps" },
    tags = "@HarmonyB2BParallelUpload and not (@pending or @bug or @skip)")
public class B2BParallelUploadWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("B2B Parallel Upload Workflow Test Suite");
