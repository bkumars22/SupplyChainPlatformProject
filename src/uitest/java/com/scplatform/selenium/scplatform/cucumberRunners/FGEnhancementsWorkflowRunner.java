/*
 * SCPlatform-9123, SCPlatform-9105, SCPlatform-9241, SCPlatform-9242, SCPlatform-9394,
 * SCPlatform-9351, SCPlatform-9608, SCPlatform-9381: Functional Group Enhancements
 */
/**
...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/fg_enhancements.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/FGEnhancements.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonyFGEnhancements and not (@pending or @bug or @skip)")
public class FGEnhancementsWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Functional Group Enhancements Workflow Test Suite");
