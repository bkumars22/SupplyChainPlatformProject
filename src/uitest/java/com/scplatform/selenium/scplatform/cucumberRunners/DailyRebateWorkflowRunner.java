...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/daily_rebate.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/DailyRebateIntegration.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonyDailyRebate and not (@pending or @bug or @skip)")
public class DailyRebateWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Daily Rebate Integration Workflow Test Suite");
