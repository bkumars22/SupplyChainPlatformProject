/*
 * SCPlatform-8867, SCPlatform-9111, SCPlatform-9370, SCPlatform-9482, SCPlatform-9658, SCPlatform-9654:
 * BOM Enhancements
 */
/**
...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/bom_enhancements.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/BOMEnhancements.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonyBOMEnhancements and not (@pending or @bug or @skip)")
public class BOMEnhancementsWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("BOM Enhancements Workflow Test Suite");
