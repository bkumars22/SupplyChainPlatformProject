...
@CucumberOptions(
    plugin = {"json:target/cucumber-html-report/debug.json", "html:target/cucumber-html-report/cucumber.html",
    "junit:target/cucumber-junit-report.xml"},
    features = {"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/Debug.feature"},
    glue = {"com.test.selenium.common.steps", "com.test.selenium.api.e2na.steps",
    "com.test.selenium.scplatform.steps"},
    tags = "@debug and not (@pending or @bug or @skip)")
public class DebugRunner extends E2CukeBase {
  ...
  public void beforeSuite () {
    ...
    // --- Setup for Report --
    setReportTitle("[DEBUG] Basic Workflow Test Plan");
