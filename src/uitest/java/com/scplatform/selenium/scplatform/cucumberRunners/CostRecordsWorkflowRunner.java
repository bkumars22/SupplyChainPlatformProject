...
@CucumberOptions(plugin = { "json:target/cucumber-html-report/cost_records.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml" }, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/CostRecords.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps",
"com.test.selenium.scplatform.hooks"},
    tags = "@HarmonyCR and not (@pending or @bug or @skip)")
public class CostRecordsWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Cost Records Workflow Test Plan");
