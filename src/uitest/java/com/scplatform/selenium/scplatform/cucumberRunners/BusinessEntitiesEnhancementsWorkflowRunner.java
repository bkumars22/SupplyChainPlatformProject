/*
 * SCPlatform-8803, SCPlatform-8973, SCPlatform-8779: Business Entities Enhancements
 */
/**
...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/business_entities_enhancements.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/BusinessEntitiesEnhancements.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonyBusinessEntitiesEnhancements and not (@pending or @bug or @skip)")
public class BusinessEntitiesEnhancementsWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Business Entities Enhancements Workflow Test Suite");
