...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SanityTests202.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonySanityTests202 and not (@pending or @bug or @skip)")
public class SanityTests202WorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Sanity Tests 202 Workflow Test Plan");
