/*
 * SCPlatform-8627, SCPlatform-9656, SCPlatform-9650, SCPlatform-9112: Search Enhancements
 */
/**
...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/search_enhancements.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SearchEnhancements.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonySearchEnhancements and not (@pending or @bug or @skip)")
public class SearchEnhancementsWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Search Enhancements Workflow Test Suite");
