...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/CostRecords202.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps"},
    tags = "@HarmonyCR202 and not (@pending or @bug or @skip)")
public class CostRecordsWorkflowRunner202 extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Cost Records 202 Workflow Test Plan");
