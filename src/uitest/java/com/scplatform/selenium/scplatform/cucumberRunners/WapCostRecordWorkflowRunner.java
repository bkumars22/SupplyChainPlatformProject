...
@CucumberOptions(plugin = { "json:target/cucumber-html-report/wapcostrecord.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml" }, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/WapCostRecord.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps"},
    tags = "@HarmoneyWAPCR and not (@pending or @bug or @skip)")

public class WapCostRecordWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("WAP Cost Records Workflow Test Plan");
