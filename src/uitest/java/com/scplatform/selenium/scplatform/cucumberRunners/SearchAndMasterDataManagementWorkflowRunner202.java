...
@CucumberOptions(plugin = { "json:target/cucumber-html-report/search202.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml" }, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SearchAndMasterDataManagement202.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps"},
    tags = "@HarmonySearch202 and not (@pending or @bug or @skip)")
public class SearchAndMasterDataManagementWorkflowRunner202 extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Search And Master Data Management Workflow 202 Test Plan");
