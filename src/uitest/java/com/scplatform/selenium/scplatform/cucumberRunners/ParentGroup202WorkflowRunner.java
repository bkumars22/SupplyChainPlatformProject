...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/ParentGroup202.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyPG202 and not (@pending or @bug or @skip)")
public class ParentGroup202WorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Parent Group 202 Workflow Test Plan");
