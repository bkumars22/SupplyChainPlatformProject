...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/TAMItems.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyTam and not (@pending or @bug or @skip)")
public class TamWorkflowRunner extends E2CukeBase {
