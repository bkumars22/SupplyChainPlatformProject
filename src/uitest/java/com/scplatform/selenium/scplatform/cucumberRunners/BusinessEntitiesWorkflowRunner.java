...
@CucumberOptions(plugin = { "json:target/cucumber-html-report/business_records.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml" }, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/BusinessEntities.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps"},
    tags = "@HarmonyTest and not (@pending or @bug or @skip)")
public class BusinessEntitiesWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Business Entities Workflow Test Plan");
