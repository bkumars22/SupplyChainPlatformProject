/*
 * SCPlatform-8829: Sourcing Lane Enhancements
 */
/**
...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/sourcing_lane_enhancements.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SourcingLaneEnhancements.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonySourcingLaneEnhancements and not (@pending or @bug or @skip)")
public class SourcingLaneEnhancementsWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Sourcing Lane Enhancements Workflow Test Suite");
