...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/incremental_rebate.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/IncrementalRebate.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonyIncrementalRebate and not (@pending or @bug or @skip)")
public class IncrementalRebateWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Incremental Rebate Workflow Test Suite");
