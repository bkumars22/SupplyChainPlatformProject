...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/Admin.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyAdmin and not (@pending or @bug or @skip)")
public class AdminWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Admin Workflow Test Plan");
