...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/FunctionalGroups.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyFG and not (@pending or @bug or @skip)")
public class FunctionalGroupsWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Functional Groups Workflow Test Plan");
