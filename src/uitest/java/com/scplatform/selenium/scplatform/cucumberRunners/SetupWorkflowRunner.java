...
@CucumberOptions(plugin = { "com.test.selenium.common.cucumber.plugins.TestStepWatch",
    "json:target/cucumber-html-report/setup.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml" }, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SetupDevBox.feature" }, glue = {
    "com.test.selenium.common.steps", "com.test.selenium.scplatform.steps" },
    tags = "@setup and not (@pending or @bug or @skip)")
public class SetupWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Setup Test Plan");
