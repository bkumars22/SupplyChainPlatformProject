...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/FunctionalGroups194.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyFG194 and not (@pending or @bug or @skip)")
public class FunctionalGroups194WorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Functional Groups 194 Workflow Test Plan");
