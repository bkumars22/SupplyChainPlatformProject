...
@CucumberOptions(plugin = {"com.test.selenium.common.cucumber.plugins.TestStepWatch",  "json:target/cucumber-html-report/functional_groups.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml"}, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/FunctionalGroups202.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyFG202 or @pending and not (@pending or @bug or @skip)")
public class FunctionalGroups202WorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Functional Groups 202 Workflow Test Plan");
