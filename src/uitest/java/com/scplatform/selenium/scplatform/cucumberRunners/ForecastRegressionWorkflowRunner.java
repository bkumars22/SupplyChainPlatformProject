...
@CucumberOptions(plugin = { "com.test.selenium.common.cucumber.plugins.TestStepWatch",
    "json:target/cucumber-html-report/forecastReg.json", "html:target/cucumber-html-report/cucumber.html",
...
public class ForecastRegressionWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Forecast Regression Workflow Test Plan");
