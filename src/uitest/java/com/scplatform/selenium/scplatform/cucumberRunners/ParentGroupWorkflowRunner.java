...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/ParentGroup.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonyPG and not (@pending or @bug or @skip)")
public class ParentGroupWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Parent Group Workflow Test Plan");
