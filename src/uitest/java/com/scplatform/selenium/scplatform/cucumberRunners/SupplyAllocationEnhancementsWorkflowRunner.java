/*
 * SCPlatform-8475, SCPlatform-8597, SCPlatform-8725, SCPlatform-9176, SCPlatform-9734:
...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/supply_allocation_enhancements.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SupplyAllocationEnhancements.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonySupplyAllocationEnhancements and not (@pending or @bug or @skip)")
public class SupplyAllocationEnhancementsWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("Supply Allocation Enhancements Workflow Test Suite");
