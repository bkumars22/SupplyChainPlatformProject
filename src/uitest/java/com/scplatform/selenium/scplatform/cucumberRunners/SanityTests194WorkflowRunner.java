...
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/SanityTests194.feature" }, glue = {
    "com.test.selenium.common.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@HarmonySanityTests194 and not (@pending or @bug or @skip)")
public class SanityTests194WorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Sanity Tests 194 Workflow Test Plan");
