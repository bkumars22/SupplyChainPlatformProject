...
@CucumberOptions(plugin = {
        ...
        "json:target/cucumber-html-report/b2b_record_source.json",
        "html:target/cucumber-html-report/cucumber.html",
        "junit:target/cucumber-junit-report.xml" }, features = {
                "src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/B2BRecordSource.feature" }, glue = {
                        "com.test.selenium.common.steps",
                        "com.test.selenium.scplatform.steps" }, tags = "@HarmonyB2BRecordSource and not (@pending or @bug or @skip)")
public class B2BRecordSourceWorkflowRunner extends E2CukeBase {
    ...
    public void beforeSuite() {
        ...
        setReportTitle("B2B Record Source Workflow Test Suite");
