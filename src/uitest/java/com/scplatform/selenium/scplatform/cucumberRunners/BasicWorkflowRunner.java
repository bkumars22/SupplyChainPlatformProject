...
@CucumberOptions(plugin = { "json:target/cucumber-html-report/basic_workflow.json", "html:target/cucumber-html-report/cucumber.html",
"junit:target/cucumber-junit-report.xml" }, features = {
"src/test/resources/com/scplatform/selenium/scplatform/cucumberFeatures/BasicWorkflow.feature" }, glue = {
    "com.test.selenium.common.steps", "com.test.selenium.api.e2na.steps",
"com.test.selenium.scplatform.steps" },
    tags = "@BasicWorkflow or @pending and not (@pending or @bug or @skip)")
public class BasicWorkflowRunner extends E2CukeBase {
  ...
  public void beforeSuite() {
    ...
    // --- Setup for Report --
    setReportTitle("Basic Workflow Test Plan");
