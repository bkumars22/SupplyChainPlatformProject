...
public class SearchItemsResultsPage extends SCPlatformSearchResultsPage {

	public By tableLocator()	{
		return By.id("itemSearchResultTable_data");
	}
	
	public List<SearchItemsResultsModel> parseResults() {
    	List<SearchItemsResultsModel> tableData = new ArrayList<SearchItemsResultsModel>();
       	SearchItemsResultsModel data = new SearchItemsResultsModel();
    	...
    	for (int row = 1; row < tableSize; row++)	{
    		data = new SearchItemsResultsModel();
