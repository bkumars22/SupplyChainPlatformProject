...
/**
 * DOCUMENTATION: http://confluence.dev.scplatform.local/display/QA/Commodity+Management
 * @author dgenrich
 *
 */
public class CommodityManagementController extends SCPlatformSearchController {

	@Override
	public PageImpl getView() {
		return new CommodityManagementPage();
	}
